...
## Dependency:  N/A
##
ifeq ($(MTK_WIFI_ROM_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Dependency:  libwifi.a libwifi_aw7698_ram.a
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
ifeq ($(MTK_WIFI_REPEATER_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
##
ifeq ($(MTK_WIFI_DHCPD_DHCP_COEXIST_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Usage:  Need to enable in MT7686/82/32/AW7698
## Path:   middleware/MTK/connsys/src/connsys_util.c
##         middleware/MTK/connsys/src/connsys_driver.c
## Dependency:  N/A
##
ifeq ($(MTK_CM4_WIFI_TASK_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Usage:Only need to enable in MT7687/97, MT7686/82/32/AW7698 needn't  (Not BT Combo)
## Path:  middleware/MTK/connsys/src/connsys_util.c
## Dependency:  N/A
##
...
## Usage:  only support in MT7686/82/32/AW7698, MT7687/97 not support (flash layout need to modify)
## Path:  middleware/MTK/connsys/src/connsys_util.c
...
##              include the libwifi.a libwifi_aw7698_ram.a
## Path:        middleware/MTK/wifi_stack/src
## Dependency:  libwifi libwifi_aw7698_ram
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
ifeq ($(MTK_WIFI_WPS_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
##
## AIRKISS_ENABLE_CRYPT
## Brief:       This option is to enable airkiss encryption by aes key.
## Usage:       If the value is "y", the AIRKISS_ENABLE_CRYPT compile option will be defined. You must also include the middleware/third_party/cloud/Tencent_weixin/module.mk in your Makefile before setting the option to "y".
## Path:        middleware/third_party/cloud/Tencent_weixin
## Dependency:  MTK_AIRKISS_ENABLE must be enabled.
##              The default airkiss AES Key is defined by AIRKISS_AES_KEY in middleware/third_party/cloud/tencent_weixin/inc/airkiss.h
##
ifeq ($(AIRKISS_ENABLE_CRYPT),y)
COM_CFLAGS         += -DAIRKISS_ENABLE_CRYPT
endif
...
## Related doc: None
##
ifeq ($(MTK_BLE_SMTCN_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
##
## MTK_SYSTEM_HANG_TRACER_ENABLE
## Brief:       This option is to debug system hang issue.
## Usage:       The valid values are o1, o2.
...
COM_CFLAGS += -DMTK_SAVE_LOG_TO_FLASH_ENABLE
endif
##
...
##
ifeq ($(MTK_IPERF_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Relative doc:N/A.
##
ifeq ($(MTK_LWIP_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Relative doc:N/A.
##
ifeq ($(MTK_LWIP_STATISTICS_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Dependency:  MTK_MINICLI_ENABLE must be defined in the project.
##
ifeq ($(MTK_PING_OUT_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
ifeq ($(MTK_SMTCN_V4_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
ifeq ($(MTK_SMTCN_V5_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
##
## MTK_AUDIO_ES8388_DAC_ENABLED
## Brief:       This option is temp used and it is to enable audio playback with DAC.
## Path:        project/$(BOARD_CONFIG)/apps/audio_ref_design
## Dependency:  HAL_I2S_MODULE_ENABLED must be defined in the project.
##
ifeq ($(MTK_AUDIO_ES8388_DAC_ENABLED), y)
CFLAGS += -DMTK_AUDIO_ES8388_DAC_ENABLED
endif

##
## MTK_AUDIO_NAU8810_DAC_ENABLED
## Brief:       This option is temp used and it is to enable audio playback with DAC.
## Path:        project/$(BOARD_CONFIG)/apps/audio_ref_design
## Dependency:  MTK_AUDIO_NAU8810_DAC_ENABLED must be defined in the project.
##
ifeq ($(MTK_AUDIO_NAU8810_DAC_ENABLED), y)
CFLAGS += -DMTK_AUDIO_NAU8810_DAC_ENABLED
endif
...
## Realted doc: None
##
ifeq ($(MTK_WIFI_CONFIGURE_FREE_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Realted doc: None
##
ifeq ($(MTK_WIFI_TGN_VERIFY_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
...
## Usage:       Enable the feature by configuring it as y.
## Path:        middleware/MTK/secure_boot_protected
...
##
## MTK_WIFI_ENABLE
## Brief:       This option is to enable Wi-Fi feature in project.
## Usage:       Enable the feature by configuring it as y.
## Path:        wifi project
## Dependency:  None
## Notice:      None
...
## Usage:       Enable the feature by configuring it as y.
## Path:        project/aw7698_evk/apps/iot_sdk_demo/src/sys_init.c, middleware/MTK/connsys/src/connsys_util.c
## Dependency:  None
## Notice:      None
## Relative doc:None
##
...
## Usage:       If the value is "y", the MTK_NO_PSRAM_ENABLE will be defined, PSRAM will be initialized 
##              in the initialization phase the option to "y" include the driver/chip/mtxxxx/module.mk.
##              AW7698M with PSRAM and AW7698N without PSRAM.
...
##
## MTK_WIFI_SINGLE_RATE_ENABLE
## Brief:       This option is to enable single rate test mode.
## Usage:       Enable the feature by configuring it as y.
## Path:
## Dependency:  None
## Notice:      None
## Relative doc:None
##
ifeq ($(MTK_WIFI_SINGLE_RATE_TEST_ENABLE),y)
COM_CFLAGS  += -DMTK_WIFI_SINGLE_RATE_TEST
endif
...
## Related doc: None.
##
ifeq ($(MTK_WIFI_PROFILE_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
COM_CFLAGS += -DMTK_WIFI_PROFILE_ENABLE
endif

##
## MTK_BWCS_ENABLE
## Brief:       This option is to enable BT WIFI Coex Scheme
## Usage:       Enable the feature by configuring it as y
## Path:        middleware/MTK/bwcs
## Dependency:  TBD
## Notice:      TBD
## Relative doc:TBD
##
ifeq ($(MTK_BWCS_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
COM_CFLAGS         += -DMTK_BWCS_ENABLE
endif
...
## Related doc: None.
##
ifeq ($(MTK_TF_WIFI_AUTO_TEST)_$(MTK_WIFI_ENABLE),y_y)
COM_CFLAGS += -DMTK_TF_WIFI_AUTO_TEST
endif

##
## MTK_WIFI_CLI_ENABLE
## Brief:       1.This option is only used to enable the wifi cli command, include wifi_cli, wifi_private_cli, mlme_cli.
## Usage:       In project, enable MTK_WIFI_CLI_ENABLE=y in feature.mk
## Path:        middleware/MTK/minicli/inc
## Dependency:  No
## Notice:      1.MTK_WIFI_CLI_ENABLE is the main switch of wifi moudle. Disable this option, all the wifi cli will be disable. Enable this option also need MTK_WIFI_ENABLE=y .
##              2.In 7686/7682, also have MLME_cli, if you want to enable MLME_cli, should enable MTK_WIFI_CLI_ENABLE fristly, then enbale MLME_cli option.
##              3.MTK_WIFI_CLI_ENABLE is default enable
## Related doc: None.
##
ifeq ($(MTK_WIFI_CLI_ENABLE)_$(MTK_WIFI_ENABLE),y_y)
COM_CFLAGS += -DMTK_WIFI_CLI_ENABLE
endif

##
## MTK_HAL_SW_EXT_32K_ENABLE
## Brief:       This option is to enable external 32K and don't care about the status of strap pin.
## Usage:       Enable the feature by configuring it as y.
## Path:
## Dependency:  None
## Notice:      None
## Relative doc:None
##
ifeq ($(MTK_HAL_SW_EXT_32K_ENABLE),y)
COM_CFLAGS         += -DMTK_HAL_SW_EXT_32K_ENABLE
endif

##
## MTK_HAL_SW_INT_32K_ENABLE
## Brief:       This option is to enable internal 32K and don't care about the status of strap pin.
## Usage:       Enable the feature by configuring it as y.
## Path:
## Dependency:  None
## Notice:      None
## Relative doc:None
##
ifeq ($(MTK_HAL_SW_INT_32K_ENABLE),y)
COM_CFLAGS         += -DMTK_HAL_SW_INT_32K_ENABLE
endif
...
COM_CFLAGS += -I$(SOURCE_DIR)/driver/CMSIS/Device/airoha/aw7698/Include
COM_CFLAGS += -I$(SOURCE_DIR)/driver/CMSIS/Include
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/aw7698/inc
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/connsys/inc
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/inc
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/aw7698/src/common/include
...
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/third_party/mqtt/MQTTClient-C/src/FreeRTOS
...
ifeq ($(MTK_SECURE_BOOT_ENABLE),y)
COM_CFLAGS += -I$(SOURCE_DIR)/prebuilt/middleware/MTK/secure_boot/inc
endif
...
DRV_CHIP_PATH 		= $(SOURCE_DIR)/driver/chip/aw7698
DRV_BSP_PATH 		= $(SOURCE_DIR)/driver/board/aw7698_evk
