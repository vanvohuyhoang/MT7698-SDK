...
ifeq ($(IC_TYPE),mt7686ds)
COM_CFLAGS += -DMT7686DS
endif
...
## Dependency:  libwifi.a libwifi_mt7686_ram.a
...
##              include the libwifi.a libwifi_mt7686_ram.a
## Path:        middleware/MTK/wifi_stack/src
## Dependency:  libwifi libwifi_mt7686_ram
## Related doc: Please refer to wifi dev guide under the doc folder for more detail.
##
...
ifeq ($(MTK_MBEDTLS_USE_PROJECT),y)
COM_CFLAGS += -I$(SOURCE_DIR)/project/mt7686_hdk/apps/story_reader_ref_design/src/mbedtls/include
COM_CFLAGS += -I$(SOURCE_DIR)/project/mt7686_hdk/apps/story_reader_ref_design/src/mbedtls/configs
else
...
ifeq ($(MTK_MBEDTLS_USE_PROJECT),y)
MID_MBEDTLS_PATH 	= $(SOURCE_DIR)/project/mt7686_hdk/apps/story_reader_ref_design/src/mbedtls
else
