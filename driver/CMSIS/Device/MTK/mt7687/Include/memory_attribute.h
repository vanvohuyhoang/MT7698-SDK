...
#define ATTR_RWDATA_IN_NONCACHED_SYSRAM 
#define ATTR_ZIDATA_IN_NONCACHED_SYSRAM
#define ATTR_RWDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN  __attribute__ ((__aligned__(4)))
#define ATTR_ZIDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN  __attribute__ ((__aligned__(4)))
...
#define ATTR_RWDATA_IN_NONCACHED_RAM
#define ATTR_ZIDATA_IN_NONCACHED_RAM
#define ATTR_RWDATA_IN_NONCACHED_RAM_4BYTE_ALIGN  _Pragma("data_alignment=4")    
#define ATTR_ZIDATA_IN_NONCACHED_RAM_4BYTE_ALIGN  _Pragma("data_alignment=4")

#define ATTR_RWDATA_IN_NONCACHED_SYSRAM 
#define ATTR_ZIDATA_IN_NONCACHED_SYSRAM
#define ATTR_RWDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN  _Pragma("data_alignment=4")
#define ATTR_ZIDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN  _Pragma("data_alignment=4"))
