...
#define __MPU_PRESENT             1       /*!< AW7698 provides an MPU                        */
#define __NVIC_PRIO_BITS          5       /*!< AW7698 uses 5 Bits for the Priority Levels    */
...
typedef enum IRQn {
    ...
    /****  AW7698 specific external/peripheral interrupt ****/
    DMA_IRQn                    =  0,
    SPI_MST_IRQn                =  1,
    SPI_SLV_IRQn                =  2,
    SDIO_SLV_IRQn               =  3,
...
#include "system_aw7698.h"

/* AW7698 private config */
...
#define CM4_MTK_CRYPTO_BASE		0xA0060000  // AW7698
...
//#define AES_MODE_CTR_OFFSET     (7)	    // AW7698 N/A
