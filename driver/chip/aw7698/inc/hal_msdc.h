...
#define MSDC_REG  ((msdc_register_t *)SDIO_MASTER_BASE) /*defined in aw7698.h*/
...
typedef enum {
    ...
    MSDC_SDIO_BUS_WIDTH_8BITS = 2,                                        /**< The SDIO bus width is 8 bits. */
} msdc_bus_width_t;
