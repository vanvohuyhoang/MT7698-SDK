...
#define EX_GPIO_MODE_GPIO       0
#define EX_GPIO_MODE_PWM1       1
#define EX_GPIO_MODE_PWM2       2
#define EX_GPIO_MODE_PWM3       3
#define EX_GPIO_MODE_PWM4       4
#define EX_GPIO_MODE_LED0       5
#define EX_GPIO_MODE_LED1       6
#define EX_GPIO_MODE_LED2       7
#define EX_GPIO_MODE_LED3       8
#define EX_GPIO_MODE_XO_16M     12
#define EX_GPIO_MODE_XO_DIV     13
#define EX_GPIO_MODE_XO_32K     14
#define EX_GPIO_MODE_RCO_32K    15
