 ...
 *  The platform supports a total of 42 GPIO pins with various functionality. \n
 *  Note: The GPIO pin of EX_GPIO_x just support hal_gpio_init() and hal_gpio_deinit() and hal_pinmux_set_function() and hal_gpio_set_direction() and hal_gpio_set_output().
*/
...
typedef enum {
    ...
    EX_GPIO_0   = 23,                          /**< EX GPIO pin0 */
    EX_GPIO_1   = 24,                          /**< EX GPIO pin1 */
    EX_GPIO_2   = 25,                          /**< EX GPIO pin2 */
    EX_GPIO_3   = 26,                          /**< EX GPIO pin3 */
    EX_GPIO_4   = 27,                          /**< EX GPIO pin4 */
    EX_GPIO_6   = 29,                          /**< EX GPIO pin6 */
    EX_GPIO_7   = 30,                          /**< EX GPIO pin7 */
    EX_GPIO_8   = 31,                          /**< EX GPIO pin8 */
    EX_GPIO_9   = 32,                          /**< EX GPIO pin9 */
    EX_GPIO_10  = 33,                          /**< EX GPIO pin10 */
    EX_GPIO_12  = 35,                          /**< EX GPIO pin12 */
    EX_GPIO_13  = 36,                          /**< EX GPIO pin13 */
    EX_GPIO_14  = 37,                          /**< EX GPIO pin14 */
    EX_GPIO_15  = 38,                          /**< EX GPIO pin15 */
    EX_GPIO_18  = 41,                          /**< EX GPIO pin18 */
 ...
 *  Note: The PWM channel of EX_PWM_x just support hal_pwm_init() and hal_pwm_deinit() and hal_pwm_set_frequency() and hal_pwm_set_duty_cycle() and hal_pwm_start() and hal_pwm_stop().
*/
typedef enum {
    ...
    EX_PWM_1  = 6,                            /**< EX PWM channel 1(PWM frequency must be smaller than 10000). */
    EX_PWM_2  = 7,                            /**< EX PWM channel 2(PWM frequency must be smaller than 10000). */
    EX_PWM_3  = 8,                            /**< EX PWM channel 3(PWM frequency must be smaller than 10000). */
    EX_PWM_4  = 9,                            /**< EX PWM channel 4(PWM frequency must be smaller than 10000). */
...
typedef enum {
    ...
    EX_PWM_CLOCK_16MHZ  = 3,                /**< EX PWM clock srouce 16MHz(EX PWM channel can only use this clock soure). */
