...
void msdc_dump_all_reg(void)
{
    msdc_register_t *msdc_register_base;

    msdc_register_base = MSDC_REG;

    MSDC_DEBUG_LOG("MSDC_CFG:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_CFG);
    MSDC_DEBUG_LOG("MSDC_IOCON:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_IOCON);
    MSDC_DEBUG_LOG("MSDC_PS:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_PS);
    MSDC_DEBUG_LOG("MSDC_INT:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_INT);
    MSDC_DEBUG_LOG("MSDC_INTEN:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_INTEN);
    MSDC_DEBUG_LOG("MSDC_FIFOCS:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_FIFOCS);
    MSDC_DEBUG_LOG("MSDC_TXDATA:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_TXDATA);
    MSDC_DEBUG_LOG("MSDC_RXDATA:0x%08x\r\n",(unsigned int)msdc_register_base->MSDC_RXDATA);
    MSDC_DEBUG_LOG("SDC_CFG:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_CFG);
    MSDC_DEBUG_LOG("SDC_CMD:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_CMD);
    MSDC_DEBUG_LOG("SDC_ARG:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_ARG);
    MSDC_DEBUG_LOG("SDC_STS:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_STS);
    MSDC_DEBUG_LOG("SDC_RESP0:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_RESP0);
    MSDC_DEBUG_LOG("SDC_RESP1:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_RESP1);
    MSDC_DEBUG_LOG("SDC_RESP2:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_RESP2);
    MSDC_DEBUG_LOG("SDC_RESP3:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_RESP3);
    MSDC_DEBUG_LOG("SDC_BLK_NUM:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_BLK_NUM);
    MSDC_DEBUG_LOG("SDC_CSTS:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_CSTS);
    MSDC_DEBUG_LOG("SDC_CSTS_EN:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_CSTS_EN);
    MSDC_DEBUG_LOG("SDC_DATCRC_STS:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_DATCRC_STS);
    MSDC_DEBUG_LOG("SDC_ACMD_RESP:0x%08x\r\n",(unsigned int)msdc_register_base->SDC_ACMD_RESP);
    MSDC_DEBUG_LOG("DMA_SA:0x%08x\r\n",(unsigned int)msdc_register_base->DMA_SA);
    MSDC_DEBUG_LOG("DMA_CA:0x%08x\r\n",(unsigned int)msdc_register_base->DMA_CA);
    MSDC_DEBUG_LOG("DMA_CTRL:0x%08x\r\n",(unsigned int)msdc_register_base->DMA_CTRL);
    MSDC_DEBUG_LOG("DMA_CFG:0x%08x\r\n",(unsigned int)msdc_register_base->DMA_CFG);
    MSDC_DEBUG_LOG("SW_DBG_SEL:0x%08x\r\n",(unsigned int)msdc_register_base->SW_DBG_DEL);
    MSDC_DEBUG_LOG("SW_DBG_OUT:0x%08x\r\n",(unsigned int)msdc_register_base->SW_DBG_OUT);
    MSDC_DEBUG_LOG("DMA_LENGTH:0x%08x\r\n",(unsigned int)msdc_register_base->DMA_LENGTH);
    MSDC_DEBUG_LOG("PATCH_BIT0:0x%08x\r\n",(unsigned int)msdc_register_base->PATCH_BIT0);
    MSDC_DEBUG_LOG("PATCH_BIT1:0x%08x\r\n",(unsigned int)msdc_register_base->PATCH_BIT1);
    MSDC_DEBUG_LOG("PAD_TUNE:0x%08x\r\n",(unsigned int)msdc_register_base->PAD_TUNE);
    MSDC_DEBUG_LOG("DAT_RD_DLY0:0x%08x\r\n",(unsigned int)msdc_register_base->DAT_RD_DLY0);
    MSDC_DEBUG_LOG("DAT_RD_DLY1:0x%08x\r\n",(unsigned int)msdc_register_base->DAT_RD_DLY1);
    MSDC_DEBUG_LOG("MAIN_VER:0x%08x\r\n",(unsigned int)msdc_register_base->MAIN_VER);
    MSDC_DEBUG_LOG("ECO_VER:0x%08x\r\n",(unsigned int)msdc_register_base->ECO_VER);
}
