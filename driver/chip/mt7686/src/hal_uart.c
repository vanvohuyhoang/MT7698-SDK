...
#ifdef HAL_SLEEP_MANAGER_ENABLED
#define HAL_UART_FEATURE_RX_WAKEUP_SUPPORT
#endif
...
#if defined(HAL_SLEEP_MANAGER_ENABLED) && defined(HAL_UART_FEATURE_RX_WAKEUP_SUPPORT)
...
#endif
#ifdef HAL_UART_FEATURE_RX_WAKEUP_SUPPORT
            {
