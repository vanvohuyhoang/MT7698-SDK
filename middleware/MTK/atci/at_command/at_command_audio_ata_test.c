...
uint32_t pass_through_test(pass_through_test_mic_type mic, pass_through_test_mic_side side, pass_through_test_freq freq, pPTT_u4Freq_Mag_data result)
{
    ...
    if (fft_bufs != NULL) {
        ...
        //KTONE_DL_ON
        {
            ...
            open_param.stream_out_param.afe.stream_out_sampling_rate    = HAL_AUDIO_SAMPLING_RATE_16KHZ;
            open_param.stream_out_param.afe.sampling_rate    = HAL_AUDIO_SAMPLING_RATE_16KHZ;
