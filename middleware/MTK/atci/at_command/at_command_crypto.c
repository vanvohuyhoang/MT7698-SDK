...
static ATTR_RWDATA_IN_NONCACHED_RAM_4BYTE_ALIGN uint8_t encrypted_buffer[16] = {0};
static ATTR_RWDATA_IN_NONCACHED_RAM_4BYTE_ALIGN uint8_t decrypted_buffer[16] = {0};
