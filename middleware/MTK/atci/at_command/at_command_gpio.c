        ...
        case ATCI_CMD_MODE_EXECUTION:
            ...
            if (strncmp(parse_cmd->string_ptr, "AT+EGPIO=GPIO_GET:", strlen("AT+EGPIO=GPIO_GET:")) == 0) {
                ...
                for (i = pin_index[0]; i <= pin_index[1]; i++) {
                    ...
                    strncpy((char *)temp1, (char *)current_state[temp], strlen((char *)current_state[temp])+1);
                    strncpy((char *)temp2, (char *)(pull_state[gpio_state.pull_type]), strlen((char *)(pull_state[gpio_state.pull_type]))+1);
            ...
            /* Set serveral configurations to one GPIO. */
                ...
                strncpy((char *)temp1, (char *)current_state[temp], strlen((char *)current_state[temp])+1);               //get current state string
                strncpy((char *)temp2, (char *)(pull_state[gpio_state.pull_type]), strlen((char *)(pull_state[gpio_state.pull_type]))+1); //get pull state string
