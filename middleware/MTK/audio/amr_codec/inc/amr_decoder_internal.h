...
#endif
#else
#define LOGMSGIDE(fmt,arg...)   LOG_MSGID_E(AMR_DEC, "[AMR DEC]: "fmt,##arg)
#define LOGMSGIDW(fmt,arg...)   LOG_MSGID_W(AMR_DEC, "[AMR DEC]: "fmt,##arg)
#if defined AMR_DECODER_LOG_ENABLE
#define LOGMSGIDI(fmt,arg...)   LOG_MSGID_I(AMR_DEC, "[AMR DEC]: "fmt,##arg)
#else
