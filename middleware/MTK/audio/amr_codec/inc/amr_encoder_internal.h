...
#ifdef AMR_ENCODER_LOG_ENABLE
log_create_module(AMR_ENC, PRINT_LEVEL_INFO);
#define LOGMSGIDE(fmt,arg...)   LOG_MSGID_E(AMR_ENC, "[AMR ENC]: "fmt,##arg)
#define LOGMSGIDW(fmt,arg...)   LOG_MSGID_W(AMR_ENC, "[AMR ENC]: "fmt,##arg)
#define LOGMSGIDI(fmt,arg...)   LOG_MSGID_I(AMR_ENC, "[AMR ENC]: "fmt,##arg)
