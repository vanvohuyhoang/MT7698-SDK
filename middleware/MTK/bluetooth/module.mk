...
#else ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG),am255x am2552))
#LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/bluetooth/lib/libbtdriver_255x_release.a
endif
...
#else ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG),am255x am2552))
#LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/bluetooth/lib/libbtdriver_255x.a
endif
