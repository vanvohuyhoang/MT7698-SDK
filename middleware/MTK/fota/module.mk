...
ifneq ($(BSP_EXTERNAL_SERIAL_FLASH_ENABLE),y)
...
# aw7698 is based on mt7686.
ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG),mt7682 mt7686 aw7698))
CFLAGS += -DMTK_FOTA_ON_7686
endif

# For aw7698 only feature.
ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG),aw7698))
CFLAGS += -DMTK_FOTA_ON_7698
endif
