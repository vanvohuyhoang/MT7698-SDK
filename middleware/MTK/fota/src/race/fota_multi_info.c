...
#define FOTA_NVDM_INCOMPATIBLE_FLAG_MARK   (FOTA_UPGRADE_INFO_FLAG_MARK)
#define FOTA_NVDM_INCOMPATIBLE_FLAG_SET    (FOTA_UPGRADE_INFO_FLAG_SET)
#define FOTA_NVDM_INCOMPATIBLE_FLAG_CLEAR  (FOTA_UPGRADE_INFO_FLAG_CLEAR)
...
bool fota_nvdm_incompatible_flag_is_set(void)
{
...
FOTA_ERRCODE fota_nvdm_incompatible_flag_clear(void)
{
    FOTA_LOG_MSGID_I("fota_nvdm_incompatible_flag_clear()", 0);
