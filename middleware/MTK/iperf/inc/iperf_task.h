...
// debug macro
// #define MTK_IPERF_DEBUG_ENABLE
// #define UDP_SERVER_JITTER_REPORT_ENABLE
#ifdef MTK_IPERF_DEBUG_ENABLE
extern bool g_iperf_debug_feature;
#endif
...
typedef struct iperf_result_struct {
    int32_t data_size;                 // receive/send buffer length - Bytes
    int32_t time;                      // receive/send total time - ms
    char total_len[20];
    char bandwidth[20];
...
#define IPERF_HEADER_DUAL_TEST (0x80000001)
