...
typedef enum {
    ...
    WIFI_COMMAND_ID_EXTENSION_PTA_CONFIG = 0x32,            /**< 0x32 (Set)          */
    ...
    WIFI_COMMAND_ID_EXTENSION_MGMT_AC3_ENABLE = 0x3A,        /**< 0x3A (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_TMAC_TCTR_ENABLE = 0x3B,       /**< 0x3B (Set/Query) */
...
#if 1
typedef enum {
    WIFI_PTA_CONFIG_ENABLE,
    WIFI_PTA_CONFIG_DISABLE,
    WIFI_PTA_CONFIG_NOCHANGE,
    WIFI_PTA_CONFIG_NONE,          //for init
    WIFI_PTA_CONFIG_NUM
} wifi_pta_config_t;

typedef enum {
    WIFI_PTA_PROFILE_CUSTOM,
    WIFI_PTA_PROFILE_SCO,
    WIFI_PTA_PROFILE_ACL,
    WIFI_PTA_PROFILE_A2DP,
    WIFI_PTA_PROFILE_MIXED,
    WIFI_PTA_PROFILE_NOCONN,
    WIFI_PTA_PROFILE_NONE,      //for init
    WIFI_PTA_PROFILE_NUM
} wifi_pta_profile_t;

typedef enum {
    WIFI_PS_PROFILE_CONTINUOUS_ACTIVE,
    WIFI_PS_PROFILE_CONTINUOUS_POWER_SAVE,
    WIFI_PS_PROFILE_FAST_SWITCH_DIRECT,
    WIFI_PS_PROFILE_FAST_SWITCH_TIME,
    WIFI_PS_PROFILE_DEFAULT,
    WIFI_PS_PROFILE_NUM
} wifi_ps_profile_t;

typedef enum {
    WIFI_PTA_1_WIRE_MODE,
    WIFI_PTA_2_WIRE_MODE,
    WIFI_PTA_3_WIRE_MODE,
    WIFI_PTA_4_WIRE_MODE,
    WIFI_PTA_1_WIRE_EXTEND_MODE,
    WIFI_PTA_2_WIRE_ESI_MODE,
    WIFI_PTA_1_WIRE_ESI_MODE,
    WIFI_PTA_WIRE_NUM
} wifi_pta_wire_t;
...
/**
 * This config structure is used by extension command,
 * WIFI_COMMAND_ID_EXTENSION_PTA_CONFIG.
 */
typedef struct _wifi_pta_config_req_t {
    wifi_pta_config_t   pta_config;
    wifi_pta_profile_t  pta_profile;
    wifi_ps_profile_t   ps_profile;
    wifi_pta_wire_t     pta_wire;
    wifi_pta_cm_mode_t  pta_cm_mode;
    wifi_pta_ant_mode_t pta_ant_mode;
} wifi_pta_config_req_t;

/**
 * Set BWCS configuration to support Coex.
 */
int32_t wifi_inband_bwcs_config(wifi_pta_config_t   pta_config,
                                wifi_pta_profile_t  pta_profile,
                                wifi_ps_profile_t   ps_profile,
                                wifi_pta_wire_t     pta_wire,
                                wifi_pta_cm_mode_t  pta_cm_mode,
...
/**
* @brief Get wifi 5G supported
*
* @return <0 means not supported
*/
...
#endif
int32_t wifi_inband_mgmt_ac3_enable(uint8_t flag_set, uint8_t  * enable);
int32_t wifi_inband_tmac_trcr_enable(uint8_t flag_set, uint8_t  * enable);
