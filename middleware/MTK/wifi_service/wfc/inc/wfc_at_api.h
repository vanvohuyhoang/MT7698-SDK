...
/**
* @brief Represents the command/response structure of #WFC_API_DEBUG_LOG command defined in wfc.
*/
typedef struct {
    wh_api_id_t api_id;
    uint8_t debug_level;

} WFC_PACK wh_set_debug_log_cmd_para_t;

typedef struct {
    int32_t error_code;
} WFC_PACK wh_set_debug_log_cmd_resp_para_t;
