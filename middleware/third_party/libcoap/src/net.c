...
coap_send_confirmed(coap_context_t *context,
  ...
  uint32_t random_add = (uint32_t)(COAP_DEFAULT_RESPONSE_TIMEOUT * COAP_DEFAULT_ACK_RANDOM_FACTOR - COAP_DEFAULT_RESPONSE_TIMEOUT) * COAP_TICKS_PER_SECOND;
  node->timeout = COAP_DEFAULT_RESPONSE_TIMEOUT * COAP_TICKS_PER_SECOND +
                  (uint32_t)(r % random_add);
  /*
  node->timeout = COAP_DEFAULT_RESPONSE_TIMEOUT * COAP_TICKS_PER_SECOND +
