...
#define MESH_DUMP_HEX_LOGW(module_name, format, data, len, ...)   \
    bt_mesh_dump_hex_log(BT_MESH_DEBUG_LOG_LEVEL_WARNING, module_name, data, len, "[**]"format, ## __VA_ARGS__)
