 ...
 *   This section introduces the Configuration Client Model APIs. It shows how to add this model, to handle responsed event, and to send Configuration Client Model message to configure mesh nodes.
 *
 * @section bt_mesh_config_client_api_usage How to use configuration client to do configuration.
 *
 * - The configuration client needs device key security to communicate with mesh nodes. The device key can be retrived from provisioner.
 * - Use #bt_mesh_model_add_configuration_client to add a configuration client to your device.
 * @code
    bt_mesh_model_add_configuration_client(&g_model_handle_config_client, g_config_client_element_index, _config_client_msg_handler);
 * @endcode
 * - All configuration status can be handled in callback registerd in #bt_mesh_model_add_configuration_client.
 * @code
                                           ...
                                           const bt_mesh_access_message_rx_t *msg, const config_client_evt_t *event)
    {
        switch (event->evt_id) {
            case CONFIG_CLIENT_EVT_COMPOSITION_DATA_STATUS: {
                printf("ConfigCompositionDataStatus\n");
                // the responsed composition data can be retrieved from event
 ...
 * @endcode
 * - Use API to send related configuration message. The responsed event is described in each API's note.
 * - Example: send a GetCompositionData message to dst_addr.
 * @code
...
/**
 * @defgroup Bluetooth_mesh_config_model_struct Struct
 * @{
*/
...
/**
 * @defgroup Bluetooth_mesh_config_model_enum Enum
 * @{
*/
...
/**
 * @defgroup Bluetooth_mesh_config_model_typedef Typedef
 * @{
 */
