 ...
 *   @{
 *   @addtogroup BluetoothMeshHealthModel Health_Model
 *   @{
 *      bt_mesh_model_health_client.h defines the Health Client Model APIs.
 *   This section introduces the Health Client Model APIs. It shows how to add this model, to handle responsed event, and to send Health Client Model message to mesh nodes.
 *
 * @section bt_mesh_health_client_api_usage How to add a health client.
 *
 * - Use #bt_mesh_model_add_health_client to add a health client to your device. Keep the model handle for further usage.
 * @code
    static void add_health_client()
    {
        uint16_t model_handle_health = 0;
        bt_mesh_model_add_health_client(&model_handle_health, element_index, _health_client_msg_handler);
    }
 * @endcode
*/

/**
 * @defgroup Bluetooth_mesh_health_client_struct Struct
 * @{
*/
...
/**
 * @defgroup Bluetooth_mesh_health_client_enum Enum
 * @{
 */
...
/**
 * @defgroup Bluetooth_mesh_health_typedef Typedef
 * @{
*/
