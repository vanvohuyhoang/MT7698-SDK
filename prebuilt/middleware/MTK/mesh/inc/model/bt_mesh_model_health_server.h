 ...
 *   This section introduces the Health Server Model APIs. It shows how to add this model and to handle responsed event.
 *
 * @section bt_mesh_health_server_api_usage How to add a health server.
 *
 * - Use #bt_mesh_model_add_health_server to add a health server to your device. Keep the model handle for further usage.
 * @code
    static void add_health_server()
    {
        uint16_t model_handle;
        bt_mesh_model_add_health_server(&model_handle, NULL);
    }
 * @endcode
*/
