...
/*
#define WPS_RET_OK                      0
#define WPS_RET_TWO_MINS_TIMEOUT            1
#define WPS_RET_SECURITY_NOT_SUPPORT    2
*/
...
#if (PRODUCT_VERSION == 5932) /* Add for xip on external flash */
#define	WSC_MODEL_NUMBER	"mt5932"
#endif

#if (PRODUCT_VERSION == 7698)
#define	WSC_MODEL_NUMBER	"aw7698"
#endif
