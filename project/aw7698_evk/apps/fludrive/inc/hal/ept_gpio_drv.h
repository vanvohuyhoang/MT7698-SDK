...
#define GPIO_PORT5_MODE   MODE_4 // 4:URXD1 : Used for URXD1
#define GPIO_PORT6_MODE   MODE_4 // 4:UTXD1 : Used for UTXD1
#define GPIO_PORT7_MODE   MODE_9 // 9:BT_PRI3 : Used for BT_PRI3
#define GPIO_PORT8_MODE   MODE_8 // 8:BT_PRI0 : Used for BT_PRI0
#define GPIO_PORT9_MODE   MODE_9 // 9:BT_PRI1 : Used for BT_PRI1
#define GPIO_PORT10_MODE   MODE_0 // 0:GPIO10 : Used for AB1613_BTRST_N
#define GPIO_PORT11_MODE   MODE_3 // 3:URXD2 : Used for URXD2
#define GPIO_PORT12_MODE   MODE_9 // 9:WIFI_ANT_SEL1 : Used for WIFI_ANT_SEL1
#define GPIO_PORT13_MODE   MODE_3 // 3:UTXD2 : Used for UTXD2
...
#define GPIO_PORT22_MODE   MODE_0 // 0:GPIO22 : Used for AB161x EINT
