...
/* for read sd task */
#define SD_CARD_THREAD_NAME              "sd_card"
#define SD_CARD_THREAD_STACKSIZE         (512 * 4)
#define SD_CARD_THREAD_PRIO              TASK_PRIORITY_HIGH
...
#endif  /* BLE_THROUGHPUT */

/* for Application task */
#define USER_ENTRY_TASK_NAME                   "lwip server"
#define USER_ENTRY_TASK_STACKSIZE              (4*1024)
#define USER_ENTRY_TASK_PRIO                   TASK_PRIORITY_NORMAL

/* for run seperately socket client*/
#define SOCKET_CLIENT_TASK_NAME      "socket_client"
#define SOCKET_CLIENT_TASK_STACKSIZE      (1024 * 4)
#define SOCKET_CLIENT_TASK_PRIO           TASK_PRIORITY_NORMAL
