...
LOG_CONTROL_BLOCK_DECLARE(BTGAP);
LOG_CONTROL_BLOCK_DECLARE(BTGATT);
LOG_CONTROL_BLOCK_DECLARE(BTATT);
LOG_CONTROL_BLOCK_DECLARE(BTSM);
LOG_CONTROL_BLOCK_DECLARE(BTTIMER);
...
LOG_CONTROL_BLOCK_DECLARE(BWCS_BT);
...
static void prvSetupHardware(void)
{
    ...
    hal_uart_set_baudrate(HAL_UART_0, HAL_UART_BAUDRATE_921600);
...
void system_init(void)
{
    ...
    /* bsp_ept_gpio_setting_init() under driver/board/aw7698_evk/ept will initialize the GPIO settings
